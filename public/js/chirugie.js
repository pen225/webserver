...
const supprimer = (index) =>{
    let ind = patientsChirugie.indexOf(patientsChirugie[index])
    patientsChirugie.splice(ind, 1)
    localStorage.setItem("patientChirugie",JSON.stringify(patientsChirugie))
    location.reload('../html/chirugie.html')
}



const modifier = (index) =>{
    console.log(patientsChirugie[index]);
        ...
        <form class="row g-3" id="formulaireDeRdv">
          ...
          <div class="col-md-6">
            ...
            <select id="service" class="form-select">
              ...
              <option value="chirugie" selected>Chirugie</option>
            </select>
          </div>
          <div class="col-12">
    ...
    document.getElementById("nom").value=patientsChirugie[index].nom;
    document.getElementById("prenom").value=patientsChirugie[index].prenom;
    document.getElementById("mail").value=patientsChirugie[index].mail;
    document.getElementById("number").value=patientsChirugie[index].telephone;
    document.getElementById("address").value=patientsChirugie[index].address;
    document.getElementById("anniv").value=patientsChirugie[index].anniversaire;

    document.getElementById("formulaireDeRdv").addEventListener('submit',(e) =>{
      e.preventDefault();
      console.log(index);
      
      patientsChirugie[index].nom=document.getElementById("nom").value;
      patientsChirugie[index].prenom=document.getElementById("prenom").value;
      patientsChirugie[index].mail=document.getElementById("mail").value;
      patientsChirugie[index].telephone=document.getElementById("number").value;
      patientsChirugie[index].address=document.getElementById("address").value;
      patientsChirugie[index].anniversaire=document.getElementById("anniv").value;

      localStorage.setItem("patientChirugie",JSON.stringify(patientsChirugie))
      location.reload('../html/churigie.html')
    })
}